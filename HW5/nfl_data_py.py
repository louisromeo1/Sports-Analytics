...
def see_pbp_cols():
    ...
    data = pandas.read_parquet(
        r'https://github.com/nflverse/nflverse-data/releases/download/pbp/play_by_play_2020.parquet', engine='auto')
    cols = data.columns
...
def import_draft_picks(years=None):
    ...
    df = pandas.read_parquet(
        r'https://github.com/nflverse/nflverse-data/releases/download/draft_picks/draft_picks.parquet', engine='auto')
...
def import_combine_data(years=None, positions=None):
    ...
    # import data
    df = pandas.read_parquet(r'https://github.com/nflverse/nflverse-data/releases/download/combine/combine.parquet',
                             engine='auto')
...
def import_qbr(years=None, level='nfl', frequency='season'):
    ...
    # import data
    url = r'https://raw.githubusercontent.com/nflverse/espnscrapeR-data/master/data/qbr-{}-{}.csv'.format(level,
                                                                                                          frequency)
